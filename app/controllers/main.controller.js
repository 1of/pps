...
jQuery(document).ready(function(){
	setTimeout(function() {
	     ...
	     $('#3D1').css('text-shadow', +rYP1/810 +'px '+rXP1/280 +'px rgba(227,6,19,.8), '+rYP1/808 +'px '+rXP1/260 +'px rgba(255,237,0,1), '+rXP1/270 +'px '+rYP1/812 +'px rgba(0,159,227,.7)');
	     });

	     $('#3D2').mousemove(function(z){
	     var rXP1 = (z.pageX - this.offsetLeft-$(this).width()/2);
	     var rYP1 = (z.pageY - this.offsetTop-$(this).height()/2);
	     $('#3D2').css('text-shadow', +rYP1/1310 +'px '+rXP1/300 +'px rgba(227,6,19,.8), '+rYP1/1308 +'px '+rXP1/280 +'px rgba(255,237,0,1), '+rXP1/290 +'px '+rYP1/1312 +'px rgba(0,159,227,.7)');
	     });	
